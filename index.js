  ...
  try {
    ...
    for (const target of targets) {
      ...
      for (const subtarget of subtargets) {
        ...
        if (
          (target === 'apm821xx' && (subtarget === 'nand' || subtarget === 'sata')) ||
          (target === 'ixp4xx' && subtarget === 'generic') ||
          (target === 'loongarch64' && subtarget === 'generic') ||
          (target === 'mpc85xx' && (subtarget === 'p1010' || subtarget === 'p1020' || subtarget === 'p2020')) ||
          (target === 'qoriq' && subtarget === 'generic') ||
          (target === 'x86' && subtarget === 'geode')
        ) {
          continue;
        }
